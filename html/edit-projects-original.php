    ...
    <body>
        ...
        <div id="overlay-fade">
            <div id="overlay">
                <div class="new-post-grid">
                    ...
                    <div class="content-new-post" id="editor"></div>
        ...
        <div id="overlay-fade-edit">
            <div id="overlay-edit">
                <div class="edit-post-grid">
                    ...
                    <div class="content-edit-post" id="editor2"></div>
        ...
        <div id="overlay-fade-cv">
            <div id="overlay-cv">
                <div class="edit-cv-grid">
                    <input class="exit-edit-cv" id="exit-edit-cv" type="submit" value="Exit">
                    <div class="content-edit-cv" id="editor3"></div>
        ...
        <script>
            ...
            **/
            ...
            document.getElementById("upload-new-changes").onclick = function() {
                ...
                var content = encodeURIComponent(editor2.getData());;
                var xhr;
                if (window.XMLHttpRequest) { // Mozilla, Safari, ...
                    xhr = new XMLHttpRequest();
                } else if (window.ActiveXObject) { // IE 8 and older
        ...
        **/
        function fadeInEditPost(post_ID) {
            ...
            editor2.setData(postContent.description);
